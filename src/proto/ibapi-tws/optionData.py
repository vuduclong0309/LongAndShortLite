...
"""
        ...
        @Links: https://tradersacademy.online/trading-lesson/python-complex-orders

This module is the real code module using in TraderAcademy lesson on TWS API on how to request data related to option
